...
<body>
    ...
    @foreach ($orden_trabajos as $ot)
        <div class="encabezado">
            ...
            <h4 class="texto">INFORME ORDENES DE TRABAJO CORRECTIVAS</h4>
        ...
        <table border="1">
            <tbody>
                <tr>
                    <td class="bold">CÓDIGO EQUIPO</td>
                    <td>{{ $ot->gama->equipo->codigo }}</td>
                    <td class="bold">NOMBRE EQUIPO</td>
                    <td>{{ $ot->gama->equipo->nombre }}</td>
                </tr>
                <tr>
                    <td class="bold"># OT</td>
                    <td>{{ $ot->id }}</td>
                ...
                <tr>
                    <td class="bold">DESCRIPCIÓN GAMMA DE MANTTO</td>
                    <td>{{ $ot->gama->descripcion }}</td>
                    <td class="bold">FECHA TERMINADA</td>
                    <td>{{ $ot->fecha_termino }}</td>
                </tr>
                <tr>
                    <td class="bold">TIEMPO ESTIMADO</td>
                    <td>{{ $ot->tiempo }}</td>
                    <td class="bold">TIEMPO EJECUTADO</td>
                    <td>{{ $ot->tiempo_ejecucion }}</td>
                </tr>
            </tbody>
        </table>
        @php
