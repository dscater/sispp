...
<head>
    <meta charset="UTF-8">
    <title>Kardex Entradas Salidas Repuestos</title>
    <style type="text/css">
        * {
...
<body>
    ...
    <div class="encabezado">
        ...
        <h4 class="texto">KARDEX DE ENTRADAS Y SALIDAS DE REPUESTOS</h4>
                ...
                @if (count($array_kardex[$registro->id]) > 0 || $array_saldo_anterior[$registro->id]['sw'])
                    ...
                    @foreach ($array_kardex[$registro->id] as $value)
                        <tr>
                            ...
                            <td>{{ $value['detalle'] }}</td>
                            @if ($value['tipo_is'] == 'INGRESO')
                                <td class="centreado">ENTRADA</td>
                                <td class="centreado">{{ $value['cantidad_ingreso'] }}</td>
                            @else
                                <td class="centreado">SALIDA</td>
